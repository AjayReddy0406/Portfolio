...
const experiences = [
  {
    ...
    responsibilities: [
      ...
      'Developed dynamic CRM dashboards using Vue.js, building reusable components and integrating APIs to display real-time customer insights and analytics',
  ...
  },
  {
    ...
    responsibilities: [
      ...
      'Integrated Vue.js components with CRM platforms, enabling seamless lead management and interaction flows through efficient data binding and state management',
  ...
  },
  {
    ...
    responsibilities: [
        ...
        'Customized CRM UI features using Vue.js, enhancing user experience and operational efficiency by designing intuitive workflows with cross-functional teams',
